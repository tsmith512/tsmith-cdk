...
export class TSmithComStack extends cdk.Stack {
  constructor(
    scope: cdk.Construct,
    id: string,
    props: AssetStorageConsumerProps
  ) {
    ...
    const emailHandler = new lambda.Function(this, "tsmith-com-emailhandler", {
      ...
      code: lambda.Code.fromAsset(
        path.join(__dirname, "../lambda/tsmith-com-emailhandler")
      ),
      environment: {
        EMAIL_DESTINATION: cdk.SecretValue.secretsManager(
          "github-oauth-token",
          { jsonField: "email-form-destination" }
        ).toString(),
        EMAIL_SOURCE: cdk.SecretValue.secretsManager("github-oauth-token", {
          jsonField: "email-form-source",
        }).toString(),
      },
    });

    // And give that lambda function permission to send me emails
    const emailSendingPolicy = new iam.Policy(
      this,
      "tsmith-com-emailhandler-policy"
    );
    emailSendingPolicy.addStatements(
    ...
    emailHandler.role &&
      emailHandler.role.attachInlinePolicy(emailSendingPolicy);

    const apiEndpoint = new apigateway.LambdaRestApi(
      this,
      "tsmith-com-emailapi",
      {
    ...
    const legacyRedirects = [
      ["/email-me", "/contact/"],
      [
        "/article/custom-styles-wordpress-visual-editor",
        "/blog/2013/wordpress-theme-editor/",
      ],
      [
        "/file/theatrical-resume",
        "/assets/pdf/taylor-smith-resume-theatrical.pdf/",
      ],
      [
        "/article/gittin-started-pantheon-multidev-fk",
        "/blog/2013/pantheon-multidev/",
      ],
      [
        "/article/change-page-template-based-panels-layout",
        "/blog/2013/panels-page-tpl/",
      ],
      [
        "/article/nodejs-rpi-ikea-trophy-lighting",
        "/blog/2013/ikea-raspberry-pi-light/",
      ],
      [
        "/article/building-personalized-portfolio-experience-drupal-7",
        "/blog/2013/drupal-7-portfolio-experience/",
      ],
      [
        "/article/rescuing-myself-email-monster-javascript-fk",
        "/blog/2014/scripting-gmail/",
      ],
      ["/article/callboard", "/blog/2014/callboard-theatre-js/"],
      ["/article/nth-child-mathematics", "/blog/2014/nth-child-math/"],
      [
        "/article/cleaner-history-interactive-commit-building-git",
        "/blog/2016/git-interactive-adding/",
      ],
    ];
    ...
    new HttpsRedirect(this, "tsmith-com-domain-direct", {
    ...
    new HttpsRedirect(this, "tsmithcreative-com-domain-direct", {
      targetDomain: "tsmith.com",
      zone: HostedZone.fromHostedZoneAttributes(
        this,
        "tsmithcreativecom-zone",
        {
